...
按影响范围至少运行对应命令。CI 会运行 Go test/vet/build、Buf lint、Web lint/typecheck/test/build 和 Android test/lint/build；生成物 diff、E2E、Docker 与人工验收仍是本地门禁。
...
| 文档与收尾 | `git diff --check`，检查相对链接和命令 |
