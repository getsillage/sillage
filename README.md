...
[`web/src/types/proto/`](web/src/types/proto/)。当前 Connect v1 已注册 AuthService、MemoService、SettingsService
与 SyncService，路径形如 `/sillage.api.v1.MemoService/ListMemos` 和
