...
buildable `design-system` module owns semantic theme tokens, the common
`MaterialTheme`, and reusable navigation, settings, and error-state components;
Android consumes them through thin host adapters.
