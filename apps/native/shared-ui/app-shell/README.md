...
that secondary destinations return to Records before the host exits. Platform
lifecycle, system Back dispatch, and packaging remain in each application host.
