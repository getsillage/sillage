...
fun sillageNativeHostStrings(languageMode: String): SillageNativeHostStrings {
    ...
    return SillageNativeHostStrings(
        ...
        exportBackupDialogTitle = if (chinese) "导出 Sillage 备份" else "Export Sillage backup",
        restoreBackupDialogTitle = if (chinese) "恢复 Sillage 备份" else "Restore Sillage backup",
