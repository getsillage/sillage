...
internal val SillageLightColors = lightColorScheme(
...
internal val SillageDarkColors = darkColorScheme(
...
internal val SillageTypography = Typography(
...
internal val SillageShapes = Shapes(
...
@Composable
fun SillageDesignTheme(darkTheme: Boolean = false, content: @Composable () -> Unit) {
    val colors = sillageColorScheme(darkTheme)
...
internal fun sillageColorScheme(darkTheme: Boolean) =
    if (darkTheme) SillageDarkColors else SillageLightColors
