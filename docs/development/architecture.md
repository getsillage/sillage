...
| `apps/native/shared-ui/` | Shared Compose Multiplatform design system and application shell; `app-shell` owns buildable appearance and root-navigation presentation policy |
