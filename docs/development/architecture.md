...
| `apps/native/desktopApp/` | Compose Desktop host, atomic local snapshot adapter, native menus and guarded window lifecycle, Windows/macOS integration, and host-native DMG/MSI verification |
