...
application root invokes that path once after authentication, keeping routine
completion silent while still surfacing conflicts and failures; manual sync
reports completion. Platform hosts retain localized strings and repository
composition without duplicating conflict or merge policy.
