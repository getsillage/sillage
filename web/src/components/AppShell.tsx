...
export function AppShell({
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900 dark:bg-gray-950 dark:text-gray-50">
      ...
      <header className="sticky top-0 z-20 flex h-14 items-center justify-between border-gray-200 border-b bg-gray-50/90 px-3 backdrop-blur-xl lg:hidden dark:border-gray-800 dark:bg-gray-950/90">
        <Wordmark />
        <button
          type="button"
          aria-label="打开导航"
