...
export const pageTitleClass =
  "text-2xl font-semibold tracking-tight text-gray-900 sm:text-[1.75rem] dark:text-gray-50";
...
export const rowLinkClass =
  "block rounded-lg px-3 py-3 transition hover:bg-gray-100/80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-400/40 dark:hover:bg-gray-800/70 dark:focus-visible:ring-gray-500/50";
